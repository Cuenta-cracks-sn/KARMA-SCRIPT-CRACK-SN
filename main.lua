...
Credits:AddLabel("script karmaxagus cracked by SN")
Credits:AddLabel("SCRIPT ECHO POR")
Credits:AddLabel("alejandro robado por johan y por karma")
Credits:AddLabel("HAZ TU PROPIO CODE BRO")
Credits:AddLabel("LMAOOOO")
